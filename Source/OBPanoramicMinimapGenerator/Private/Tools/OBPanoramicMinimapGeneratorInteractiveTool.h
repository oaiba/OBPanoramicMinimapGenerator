...
#include "OBPanoramicMinimapGeneratorInteractiveTool.generated.h"


/**
 * Builder for UOBPanoramicMinimapGeneratorInteractiveTool
 */
UCLASS()
class OBPANORAMICMINIMAPGENERATOR_API UOBPanoramicMinimapGeneratorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UOBPanoramicMinimapGeneratorInteractiveTool
 */
UCLASS(Transient)
class OBPANORAMICMINIMAPGENERATOR_API UOBPanoramicMinimapGeneratorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UOBPanoramicMinimapGeneratorInteractiveToolProperties();
...
/**
 * UOBPanoramicMinimapGeneratorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class OBPANORAMICMINIMAPGENERATOR_API UOBPanoramicMinimapGeneratorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UOBPanoramicMinimapGeneratorInteractiveToolProperties> Properties;

...
#include "OBPanoramicMinimapGeneratorEditorMode.generated.h"
 ...
 */
UCLASS()
class UOBPanoramicMinimapGeneratorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_OBPanoramicMinimapGeneratorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UOBPanoramicMinimapGeneratorEditorMode();
	virtual ~UOBPanoramicMinimapGeneratorEditorMode();
